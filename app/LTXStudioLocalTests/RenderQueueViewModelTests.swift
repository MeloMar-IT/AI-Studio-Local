...
final class RenderQueueViewModelTests: XCTestCase {
    ...
    override func setUp() {
        ...
        // Given RenderQueueViewModel is simple, we'll try with a real AppState if possible,
        // or just verify the behavior we can.
        appState = AppState()
        viewModel = RenderQueueViewModel(appState: appState)
        cancellables = []
    }
